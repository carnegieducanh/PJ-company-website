...
let slider = document.querySelector(
    ".page-content .swiper-slide .swiper-slide__list"
);
let items = document.querySelectorAll(
    ".page-content .swiper-slide .swiper-slide__list .swiper-slide__list-item"
);
let next = document.getElementById("next");
let prev = document.getElementById("prev");
let dots = document.querySelectorAll(
    ".page-content .swiper-slide .swiper-slide__dots li"
);
...
function reloadSlider() {
    ...
    let last_active_dot = document.querySelector(
        ".page-content .swiper-slide .swiper-slide__dots li.active"
    );
